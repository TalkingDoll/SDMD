...
\begin{document}
	...
	\end{remark}
	Choose $f \in \textrm{span}\{\psi_i\}_{i=1}^m$. So $f = \mathbf{\Psi}_N\mathbf{a}$. Then we have
	\begin{align*}
	...
	$$
	\lim_{n\to\infty} \mathbf{\Psi}_N A_{N,n} \mathbf{a} = \mathbf{\Psi}_N (\Psi_X^{\dagger}\mathcal{L}\Psi_X) \mathbf{a} = \mathbf{\Psi}_N A_N \mathbf{a},
	$$ 
