...
Now we have Koopman matrix approximation at discrete time $K_{N,n}(1/n)$. We will use it to construct the matrix $A_{N,n}$, which is the matrix representation of the discrete projected Koopman generators $\mathcal{A}_{N,n}$ and find its limit in strong operator topology. 
